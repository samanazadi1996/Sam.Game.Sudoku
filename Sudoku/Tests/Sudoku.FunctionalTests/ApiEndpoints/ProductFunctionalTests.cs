using Shouldly;
using Sudoku.Application.Features.Products.Commands.CreateProduct;
using Sudoku.Application.Features.Products.Commands.UpdateProduct;
using Sudoku.Application.Wrappers;
using Sudoku.Domain.Products.DTOs;
using Sudoku.FunctionalTests.Common;

namespace Sudoku.FunctionalTests.ApiEndpoints
{
