using Moq;
using Shouldly;
using Sudoku.Application.Features.Products.Commands.DeleteProduct;
using Sudoku.Application.Interfaces;
using Sudoku.Application.Interfaces.Repositories;
using Sudoku.Application.Wrappers;
using Sudoku.Domain.Products.Entities;

namespace Sudoku.UnitTests.ApplicationTests.Features.Products.Commands
{
